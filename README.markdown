...
| api/v1/short_sell_borrows|  create            |  Creates a short sell borrow order                       |  api/v1/short_sell_borrows                    |   user_id, stock_id, volume, ios_token, short_sell_borrow =>{ volume, when, measure, price_target }                                                                       |      status: "Order placed."                       |
