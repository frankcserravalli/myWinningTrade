...
(function() {
  ...
  Chosen = (function(superClass) {
    ...
    Chosen.prototype.choice_build = function(item) {
      ...
      return link.click((function(_this) {
        return function(evt) {
    ...
    Chosen.prototype.winnow_results = function() {
      var found, i, j, len, len1, option, part, parts, ref, regex, regexAnchor, result, result_id, results, searchText, startpos, text, zregex;
    ...
    Chosen.prototype.winnow_results_clear = function() {
      ...
      for (i = 0, len = lis.length; i < len; i++) {
        ...
        if (li.hasClass("group-result")) {
          results1.push(li.css('display', 'auto'));
        } else if (!this.is_multiple || !li.hasClass("result-selected")) {
          results1.push(this.result_activate(li));
        } else {
    ...
    Chosen.prototype.search_field_scale = function() {
      var dd_top, div, h, i, len, style, style_block, styles, w;
      if (this.is_multiple) {
        h = 0;
        w = 0;
...
(function() {
  $(function() {
    return setTimeout((function() {
      return $('#flash li').not('.persistent').animate({
        opacity: 0
      }, 500, function() {
        return $(this).slideUp();
      });
...
$( document ).ready(function() {
  ...
  $('#portfolio').click(function(){
    var url = $('#portfolio').find('a').attr('href');
    console.log(url);
    window.location.href = url;
  });

  $('#markets').click(function(){
    var url = $('#markets').find('a').attr('href');
    console.log(url);
    window.location.href = url;
  });

  $('#tutorial').click(function(){
    var url = $('#tutorial').find('a').attr('href');
    console.log(url);
    window.location.href = url;
  });

  $('#leaderboard').click(function(){
    var url = $('#leaderboard').find('a').attr('href');
    console.log(url);
    window.location.href = url;
  });

  $('#user').click(function(){
    var url = $('#user').find('a').attr('href');
    console.log(url);
    window.location.href = url;
  });
...
;
function to_active(thisObject){
	$('.active').removeClass('.acitve');
...
(function() {
  this.Finance = (function() {
    function Finance(tick_interval_ms) {
    ...
    Finance.prototype.subscribe = function(reference, stock_symbols_list, callback) {
      var stock_symbols;
      if (stock_symbols_list == null) {
        stock_symbols_list = '';
      }
      stock_symbols = stock_symbols_list.split(',');
      stock_symbols = _.map(stock_symbols, function(symbol) {
        return symbol.replace(/[^a-zA-Z0-9\.\-]+/g, '').toUpperCase();
      });
      this.references = _.union(this.references, reference);
      this.subscriptions[reference] = {
        stock_symbols: stock_symbols,
        callback: callback
      };
      return this.stocks = _.union(this.stocks, stock_symbols);
    };

    Finance.prototype.unsubscribe = function(reference) {
      var potential_removals, subscription;
      subscription = this.subscriptions[reference];
      if (!subscription) {
        return false;
      }
      potential_removals = subscription.stock_symbols;
      this.references = _.without(this.references, reference);
      delete this.subscriptions[reference];
      return this.stocks = _.uniq(_.flatten(_.pluck(_.values(this.subscriptions), 'stock_symbols')));
    };

    Finance.prototype.start_ticking = function() {
      this.tick();
      return this.ticker = setInterval(((function(_this) {
        return function() {
          return _this.tick();
        };
      })(this)), this.tick_interval_ms);
    };

    Finance.prototype.stop_ticking = function() {
      clearInterval(this.ticker);
      return this.ticker = null;
    };

    Finance.prototype.tick = function() {
      var query_string;
      ...
      return $.ajax('/stock/details?' + query_string, {
        type: 'GET',
        dataType: 'JSON',
        success: (function(_this) {
          return function(payload, textStatus, jqXHR) {
            _this.latest_payload = payload;
            return _this.run_callbacks();
          };
        })(this)
      });
    };

    Finance.prototype.run_callbacks = function() {
      var payload;
      payload = this.latest_payload;
      return _.each(this.references, (function(_this) {
        return function(reference) {
          var cherry_picked_payload, required_data_is_available, required_stock_symbols, subscription;
          subscription = _this.subscriptions[reference];
          required_stock_symbols = subscription.stock_symbols;
          required_data_is_available = _.all(required_stock_symbols, function(stock_symbol) {
            return _.has(payload, stock_symbol);
          });
          if (required_data_is_available) {
            cherry_picked_payload = {};
            _.each(subscription.stock_symbols, function(stock_symbol) {
              return cherry_picked_payload[stock_symbol] = payload[stock_symbol];
            });
            return subscription.callback(cherry_picked_payload);
          }
        };
      })(this));
    };
...
(function() {
  ...
  Adsense = (function() {
    function Adsense(ad_client) {
      ...
      this.initPage = bind(this.initPage, this);
    ...
    Adsense.prototype.initPage = function() {
      var ad, id, ref, results;
      ref = this.ads;
      results = [];
      for (id in ref) {
        ad = ref[id];
        results.push(ad.load());
      }
      return results;
    };
  ...
  Ad = (function() {
    function Ad(adsense, id1, container1, options1) {
  ...
  window.MyAdsense = new Adsense("ca-pub-6411672013871167");
...
(function() {
  $(function() {
    $('#buy_volume').on('keyup change', function(event) {
      var cash_after_purchase, cost_to_purchase, volume;
      ...
      if (isNaN(volume) || volume <= 0) {
        ...
        return $("#cash_buy_calculation").addClass('invalid');
      } else {
        ...
        if (cash_after_purchase < 0.0) {
          ...
          return $("#cash_buy_calculation").removeClass('invalid');
        }
      }
    });
    return $('#buy_form').on('submit', function(event) {
    ...
    update = function() {
      return $.ajax({
        ...
        success: function(html) {
          return $(".portfolio-list").replaceWith(html);
        }
      });
    };
...
(function() {
  $(document).ready(function() {
    ...
    return autocomplete.data("autocomplete")._renderItem = function(ul, item) {
      return $("<li></li>").data('item.autocomplete', item).append("<a><span class='tip'>" + item.exchDisp + "</span> <span class='symbol'>" + item.symbol + "</span> <br /><small>" + item.name + "</small></a>").appendTo(ul);
    };
  });
...
(function() {
  $(function() {
    $('#sell_volume').on('keyup change', function(event) {
      var cash_after_sale, cash_from_sale, current_shares, shares_after_sale, volume;
      volume = parseFloat($(event.target).val().replace('$', ''));
      if (isNaN(volume) || volume <= 0) {
        $("#sell_price_calculation, #cash_sell_calculation, #shares_remaining").html("You must sell at least 1 share");
        return $("#shares_remaining").addClass('invalid');
      } else {
        ...
        if (shares_after_sale < 0.0) {
          ...
          return $("#shares_remaining").removeClass('invalid');
        }
      }
    });
    return $('#sell_form').on('submit', function(event) {
      if ($(event.target).find('.invalid').size() > 0) {
...
(function() {
  $(function() {
    $('#short_sell_borrow_volume').on('keyup change', function(event) {
      var cost_to_purchase, volume;
      volume = parseFloat($(event.target).val().replace('$', ''));
      if (isNaN(volume) || volume <= 0) {
        return $("#borrow_price_calculation .notice").html("Volume must be greater than 0");
      } else {
        ...
        return $("#borrow_price_calculation .notice").html(" ");
      }
    });
    return $('#short_sell_borrow_form').on('submit', function(event) {
      if ($(event.target).find('.invalid').size() > 0) {
...
(function() {
  $(function() {
    return $(".controls").on("click", "input[data-radio='when-radio']", function() {
      var type, val;
      type = $(this).data('type');
      val = $(this).val();
      switch (val) {
        case "At Market":
          ...
          return $("#hidden-" + type + "-stop-loss").css("display", "none");
        case "Future":
          $("#hidden-" + type + "-later").css("display", "inline");
          return $("#hidden-" + type + "-stop-loss").css("display", "none");
        case "Stop-Loss":
          $("#hidden-" + type + "-later").css("display", "none");
          return $("#hidden-" + type + "-stop-loss").css("display", "inline");
      }
    });
  });
...
(function() {
  $(function() {
    return $('.stock-trend').each(function(i, e) {
      var symbol;
      symbol = $(e).data('stock-symbol');
      return finance.subscribe(e, symbol, (function(_this) {
        return function(payload) {
          var stock_details;
          stock_details = payload[symbol].table;
          return $('.current-price', e).html('$' + stock_details.current_price);
        };
      })(this));
    });
  });
