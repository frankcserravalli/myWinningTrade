  ...
  def create
    ...
    if @buy_order.place!(@stock_details)
      if params[:soc_network].eql? "linkedin"
        ...
        redirect_to("http://twitter.com/share?text=Successfully%20purchased%20" + @buy_order.volume.to_s + "%20" + stock_name + "%20stocks%20for%20$" + -@buy_order.value.round(2).to_s + "%20on%20My%20Winning%20Trade")
      else
